...
var modelName = "XYZ"; var duration = 0; 
 ...
 */
 ...
 { var costLabel = document.getElementById("calculated-cost"); var costPerDay = modelName === "XYZ" ? 100 : 213; 
 // Cost per day for each model 
...
var modelButton = document.getElementById("model-button"); function changeModel() 
...
else { modelName = "XYZ"; modelText.innerHTML = "Model XYZ"; } recalculate(); 
